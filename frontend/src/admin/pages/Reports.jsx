...
const MOCK_DATA = [
  { id: 1, title: "State of Web3 Africa 2026", date: "Jan 2026", status: "Published", downloads: 1420 },
  { id: 2, title: "Stablecoin Adoption Q1", date: "April 2026", status: "Draft", downloads: 0 },
];
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Manage downloadable reports and analytics</p>
        </div>
              ...
              {MOCK_DATA.map(row => (
                <tr key={row.id} className="hover:bg-gray-800/50 transition-colors">
                  <td className="px-6 py-4 text-white font-medium flex items-center gap-2">
                    <BarChart2 size={14} className="text-gray-500" /> {row.title}
                  </td>
                  ...
                  <td className="px-6 py-4 text-right text-gray-300">{row.downloads}</td>
